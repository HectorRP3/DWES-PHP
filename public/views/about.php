    ...
    <!-- Container Box -->
      <div class="container">
        ...
        <div class="row">
           ...
           <div class="col-xs-12 col-sm-6">
             <p class="text-muted"><strong>REFORESTA</strong> <span class="pull-right">80%</span></p>
             <div class="progress">
             ...
             <p class="text-muted"><strong>REFORESTA </strong><span class="pull-right">95%</span></p>
             <div class="progress">
             ...
             <p class="text-muted"><strong>REFORESTA</strong><span class="pull-right">90%</span></p>
             <div class="progress">
        ...
        <div class="row pricing text-center">
          ...
          <div class="col-xs-12 col-sm-4 first">
            <div class="beginner">
              <h4>REFORESTA PRO</h4>
              <h5>$99.97</h5>
              <a href="#" class="btn btn-lg sr-button">BUY</a>
            </div>
          </div>
          <div class="col-xs-12 col-sm-4 middle">
            <div class="intermediary">
              <h4>REFORESTA PRO MAX</h4>
              <h5>$199.97</h5>
              <a href="#" class="btn btn-lg sr-button">BUY</a>
            </div>
          </div>
